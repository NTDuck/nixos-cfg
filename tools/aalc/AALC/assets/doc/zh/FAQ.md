...
A: 先关闭设置最下方的“实验性功能”，然后检查AALC的“游戏使用语言”设置，确保与游戏中一致

如果还是无法解决，请检查是否变更了游戏画面质量、启用了显示器HDR，或者修改了游戏字体，使用了其他MOD（如战斗语音气泡等）
...
Q: 打开AALC时弹出错误窗口：no OPENSSL_Applink

A: 在自己电脑中，windows设置->高级系统设置->环境变量中将SSLKEYLOGFILE删除，重启AALC即可
